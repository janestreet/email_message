...
module type String_monoid = sig
  ...
  (*_ For the library to fulfill it's purpose of minimal overhead string concatenation,
      the output functions must be tightly coupled with the low-level representation.
