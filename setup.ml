(* OASIS_START *)
(* DO NOT EDIT (digest: 0d262d9d8f5642ca2118f774e89a398b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/email_message";
          ...
          sections =
            [
               ...
               Executable
                 ({
                     cs_name = "find-destination-domains";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "bin";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "email_message"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "find_destination_domains.ml"
                   });
               Executable
                 ({
                     cs_name = "mailbox-test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "mailbox_test.ml"});
               Executable
                 ({
                     cs_name = "mailbox-test-pipe";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "mailbox_test_pipe.ml"
                   });
               Executable
                 ({
                     cs_name = "mailbox-wc";
                   ...
                   {exec_custom = false; exec_main_is = "mailbox_wc.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "5\254\149F\020\226\200D.\210w\161\173\243\147\197";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
