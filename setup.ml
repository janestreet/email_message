(* OASIS_START *)
(* DO NOT EDIT (digest: 383b8f769d581c9ca23b3b107822b2f1) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("email_message", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("email_message", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet-alpha/email_message";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "E-mail message parser";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some ":\244\190{le\130\149\148p1\242x\247\182E";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
