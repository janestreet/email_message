module Headers = Email_message_kernel.Headers
module Bigstring_shared = Email_message_kernel.Bigstring_shared
module Octet_stream = Email_message_kernel.Octet_stream
module Email_content = Email_message_kernel.Content
module Encoded_word = Email_message_kernel.Private.Encoded_word
