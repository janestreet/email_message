...
let empty = of_bigstring_shared ~encoding:Encoding0.default Bigstring_shared.empty
...
let encode ~encoding bstr =
  ...
  in
  let encoding = (encoding :> Encoding0.t) in
